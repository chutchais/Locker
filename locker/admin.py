...
class TagAdmin(admin.ModelAdmin):
	...
	fieldsets = [
		(None,               {'fields': ['tagid','tag_label','tagtype','lockerport','group','description','actived','status']}),
	]
	order_fields ='tagid'
	inlines = [TagReserveInline]
	actions =[clear_reserve]
...
class LockerPortAdmin(admin.ModelAdmin):
	...
	list_filter =['lockerid__lockerid','status']
	list_display = ('portid','lockerid','get_tag','reserved','actived','status')
	fieldsets =[
